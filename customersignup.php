  ...
  <h1>Customer Login</h1>
    <form method="post">
      ...
      <input type="text" name="email" class="email" placeholder="Email " required="required" />
        <input type="password" name="password1" class="password pd-password-validation" placeholder="Password" required="required" />
        <small class="pd-password-message form-text text-muted">Hiiiii</small>
